...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <p>Use this tool to create lorem ipsum text. The text can be created with any number of paragraphs you need. </p>
            <p><a class="btn btn-primary" href="/lorem" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-lg-4">
            <h2>Create Generic Users</h2>
            <p>If you need to populate a page with generic users, use this tool to generate those users.</p>
